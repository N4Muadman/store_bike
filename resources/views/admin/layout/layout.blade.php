...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-layout="vertical" data-pc-direction="ltr"
                ...
                <ul class="pc-navbar">
                        ...
                        <ul class="pc-submenu" style="display: block; box-sizing: border-box;">
                            <li class="pc-item pc-hasmenu">
                                <a href="{{ route('admin.products.index') }}" class="pc-link">
                                    <span class="pc-mtext">Danh sách sản phẩm</span>
                                </a>
                            </li>
                            <li class="pc-item pc-hasmenu">
                                <a class="pc-link" href="{{ route('review.index') }}">Đánh giá sản phẩm</a>
                            </li>
                        </ul>
                    </li>
                    <li class="pc-item pc-hasmenu">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="{{ route('admin.contacts.index') }}" class="pc-link">
                            <span class="pc-mtext">Liên hệ khách hàng</span>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <footer class="pc-footer">
        <div class="footer-wrapper container-fluid">
            <div class="row">
                <div class="col my-1">
                    <p class="m-0"><a href="https://idai.vn/" target="_blank">TKT &#9829;</a></p>
                </div>
